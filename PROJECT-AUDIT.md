...
- Contrast review — pinned text over image-backed sections to stable light colors in both themes and kept surface-based sections theme-aware. Removed custom map overlay copy at the requested location while retaining a compact, required OpenStreetMap attribution.
